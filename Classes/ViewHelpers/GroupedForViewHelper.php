 ...
 */
class Tx_Kernaarau_ViewHelpers_GroupedForViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 * @param string $groupBy Group by this property (field[:code]) e.g. groupBy="issue:substr(value, 0, 4)"  16.08.2014/tnu
	...
	protected function groupElements(array $elements, $groupBy) {
		...
		foreach ($elements as $key => $value) {
			...
			// GroupBy code 09.05.2011, 16.08.2014/tnu
				if ($parts[1]) {
